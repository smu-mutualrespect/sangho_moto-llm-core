...
def main() -> int:
    ...
    os.environ["MOTO_LLM_RUNTIME_MODE"] = "workflow"
    os.environ["MOTO_LLM_AUDIT_FILE"] = "artifacts/workflow_probe_initiate.json"
    ...
    response_body = handle_aws_request(
        ...
        reason="manual_workflow_probe",
        source="scripts.probe_workflow_initiate_layer_upload",
    )

    print(response_body)
    print("\nAudit file written: artifacts/workflow_probe_initiate.json")
    return 0
